...
level_2.add_enemy(1, 700, 20, 400, 750, 3)
level_2.add_enemy(1, 440, 750, 120, 300, 0)
level_2.add_enemy(1, 1820, 0, 1600, 1950, 1)

level_2.add_enemy(0, 1250, 400, 1120, 1400, 4)
level_2.add_enemy(0, 1700, 100, 1600, 1950, 6)

level_2.add_enemy(0, 3000, 100, 2950, 3300, 8)

level_2.add_enemy(1, 2650, 0, 1600, 2950, 0)

level_2.add_platform(100, 450, 300, 250, 5, 0, 0)


level_2.add_platform(300, 170, 300, 250, 5, 0, -3)
level_2.add_platform(300, 565, 300, 250, 5, 0, 0)

level_2.add_platform(550, 550, 150, 100, 15, 0, 0)
level_2.add_platform(600, 100, 300, 250, 5, 2, 0)
level_2.add_platform(900, 300, 300, 250, 5, 0, -3)
level_2.add_platform(1100, 550, 300, 200, 15, 0, 0)

level_2.add_platform(1650, 400, 200, 100, 15, 0, 0)
level_2.add_platform(2200, 450, 300, 100, 10, 0, 0)

level_2.add_platform(2620, 180, 200, 340, 5, 0, 4)
level_2.add_platform(2900, 350, 300, 100, 15, 0, 0)

level_2.set_goal(3500, 380)
